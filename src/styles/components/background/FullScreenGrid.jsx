...
const FullScreenGrid = () => {
  ...
  const contentForBoxes = useMemo(() => [
    { index: 1, title: '2025', description: '年落成啟用，代表未來智慧住宅的全新里程碑' },
    { index: 6, title: '24', description: '層垂直空間，打造城市新天際線生活' },
    { index: 9, title: '80', description: '米建築總高，地標等級現代美學住宅' },
    { index: 14, title: '6', description: '種精選戶型，滿足多樣家庭需求與生活型態' },
    { index: 17, title: '100', description: '%全戶型整合智慧家居系統，從日常到安全全方位掌控' },
    { index: 22, title: '0', description: '步驟一鍵啟動智慧情境，真正做到「回家就好」的極簡生活' },
  ], []);
